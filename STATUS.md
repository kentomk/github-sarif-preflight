...
- `2026-07-22T12:38:03Z`: Go 1.26.5更新commitを専用publisherでpublic main `174da9ea24c26770aafbe63671b448a88b7225af`へ同期し、CI run `29920344328`のcompleted／successを確認した。READMEのsource installとimmutable Action pin、CHANGELOGをv0.1.1へ整合させ、最終main CI成功後にchecksum付きreleaseを作成する。
