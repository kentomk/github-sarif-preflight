...
grep -Fq 'kentomk/github-sarif-preflight@3dffb55760d105b5b9ffc1a0ff690f6c0a4cd7bc' README.md
if grep -Fq 'kentomk/github-sarif-preflight@0110e3305a1fa4f10af03a752c542fd67844f695' README.md; then
